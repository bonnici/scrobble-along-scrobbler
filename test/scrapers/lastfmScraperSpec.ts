...
describe('LastfmScraper', () => {
	...
	describe("fetchAndParse", () => {
		...
		it('should return an error code on a 404', () => {
		...
		it('should return a song if its now playing', () => {
			var jsonString =
				'{\
				  "recenttracks": {\
					"track": [\
		...
		it('should return a single song if its now playing and the track data is not a list', () => {
			var jsonString =
				'{\
				  "recenttracks": {\
					"track":\
		...
		it('should return a null song if the most recent song is not now playing', () => {
			var jsonString =
				'{\
				  "recenttracks": {\
					"track": [\
		...
		it('should return a null song if the JSON is invalid', () => {
			var jsonString =
				'{\
				  "recenttracks": {\
					"track": [\
